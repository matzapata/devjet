...
```sh:generators
yarn add devjet-pern_react-protected-routes # Install generator

# Run generator to create ProtectedRoute component
npx devjet add-protected-routes 

yarn remove devjet-pern_react-protected-routes # Remove generator
```
