...
export default function PostCard({ post }) {
    return (
        <Link href={'/posts/' + post.link}>
            <div className='flex flex-col max-w-md p-5 mx-auto bg-white border cursor-pointer md:rounded-md'>
                <img className='mx-auto mb-4 border rounded' src={post.cover} alt={post.title} />
                <div>
