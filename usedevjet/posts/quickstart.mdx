...
Devjet by default makes use of three tech stacks, REACT with optional serverless functions by vercel, PERN and NEXTJS. The best way to maximize the value that you get from us is by using the `devjet` generators to boostrap your project. Otherwise you have to figure out how our receipes fit in your current work.
...
```
npx devjet new my-react-project
# Choose react when prompted about your stack
```
...
```
npx devjet new my-pern-project
# Choose pern when prompted about your stack
```
...
```
npx devjet new my-nextjs-project
# Choose nextjs when prompted about your stack
```
